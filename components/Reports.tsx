            ...
            <div className="bg-white p-6 rounded-[20px] shadow-sm border border-slate-200 flex flex-col">
               ...
               <div className="flex items-center justify-between flex-1">
                  <div className="w-[120px] h-[120px]">
                     <ResponsiveContainer width="100%" height="100%">
                        <PieChart>
                           <Pie data={analytics.charts.splitRevenue} innerRadius={40} outerRadius={55} paddingAngle={5} dataKey="value">
                              {analytics.charts.splitRevenue.map((_, index) => <Cell key={`cell-${index}`} fill={COLORS[index % COLORS.length]} />)}
                           </Pie>
                        </PieChart>
                     </ResponsiveContainer>
                  </div>
