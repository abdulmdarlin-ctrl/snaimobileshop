...
import { Lock, ArrowRight, Layers, Mail, AlertTriangle } from 'lucide-react';
      ...
      <div className="flex-1 flex flex-col justify-center items-center p-8 z-10">
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            <p className="text-[10px] font-bold text-slate-600 uppercase tracking-widest opacity-50">Crafted by ABI-TECH</p>
          </div>
        </div>
      </div>
    </div>
